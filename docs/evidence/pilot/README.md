...
The validator accepts only a fixed field allowlist. It rejects direct-identifier fields, raw SQL/result fields, cohorts below five, invented Wilson intervals, unknown task/lesson IDs, impossible denominators and a delayed session outside the documented 7–14 day window.
